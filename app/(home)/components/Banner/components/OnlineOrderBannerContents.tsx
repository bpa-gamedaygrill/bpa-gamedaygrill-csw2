...
const OnlineOrderBannerContents = () => {
  return (
    <>
          ...
          <div className="relative w-full h-full md:w-3/4 lg:w-1/2 z-20 px-12 py-11 text-white flex flex-col md:items-start justify-center gap-6 items-center">
            ...
            <h1 className="md:text-4xl text-2xl font-bold md:text-left text-center">Enjoy your favorite food, delivered straight to you.</h1>
            <p className="opacity-70 max-w-[80%] md:text-left text-center">Order food for delivery or pickup on the Game Day Grill website.</p>
                      <Link 
            href="order"
